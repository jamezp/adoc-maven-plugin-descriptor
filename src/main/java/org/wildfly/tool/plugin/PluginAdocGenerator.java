...
import org.wildfly.tool.plugin.formatters.Formatter;
import org.wildfly.tool.plugin.formatters.Formatters;
...
public class PluginAdocGenerator implements org.apache.maven.tools.plugin.generator.Generator {
    ...
    private String makeHtmlValid(String description) {
        ...
        for (Formatter formatter : Formatters.all()) {
    ...
    private String escapeAsciidoc(final String text) {
        String result = text;
        if (result != null) {
